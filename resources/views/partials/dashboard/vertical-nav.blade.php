<ul class="navbar-nav iq-main-menu" id="sidebar">
    ...
    @if(in_array('dashboard', userPermissions()))
        <li class="nav-item">
            ...
            {{-- @php
                var_dump(in_array('dashboard', userPermissions()));
            @endphp --}}
        </li>
    @endif
    ...
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-home" role="button" aria-expanded="false"
            aria-controls="sidebar-home">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path opacity="0.4"
    ...
    <li class="nav-item">
        <a class="nav-link " data-bs-toggle="collapse" href="#sidebar-article" role="button" aria-expanded="false"
            aria-controls="sidebar-article">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path opacity="0.4"
        ...
        <ul class="sub-nav collapse" id="sidebar-article" data-bs-parent="#sidebar">
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('article.index'))}}" href="{{route('article.index')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('article_page_setting.index'))}}" href="{{route('article_page_setting.index')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
    ...
    <li class="nav-item">
        <a class="nav-link " data-bs-toggle="collapse" href="#sidebar-product" role="button" aria-expanded="false"
        ...
        <ul class="sub-nav collapse" id="sidebar-product" data-bs-parent="#sidebar">
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('category_product.index'))}}" href="{{route('category_product.index')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
    ...
    <li class="nav-item">
        <a class="nav-link {{activeRoute(route('review.index'))}}" aria-current="page" href="{{route('review.index')}}">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path opacity="0.4"
                        d="M16.0756 2H19.4616C20.8639 2 22.0001 3.14585 22.0001 4.55996V7.97452C22.0001 9.38864 20.8639 10.5345 19.4616 10.5345H16.0756C14.6734 10.5345 13.5371 9.38864 13.5371 7.97452V4.55996C13.5371 3.14585 14.6734 2 16.0756 2Z"
    ...
    <li class="nav-item">
        <a class="nav-link {{activeRoute(route('menu.index'))}}" aria-current="page" href="{{route('menu.index')}}">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path opacity="0.4"
                        d="M16.0756 2H19.4616C20.8639 2 22.0001 3.14585 22.0001 4.55996V7.97452C22.0001 9.38864 20.8639 10.5345 19.4616 10.5345H16.0756C14.6734 10.5345 13.5371 9.38864 13.5371 7.97452V4.55996C13.5371 3.14585 14.6734 2 16.0756 2Z"
    ...
    <li class="nav-item">
        <a class="nav-link " data-bs-toggle="collapse" href="#sidebar-article" role="button" aria-expanded="false"
            ...
            <span class="item-name">App Ayo</span>
            <i class="right-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
        ...
        <ul class="sub-nav collapse" id="sidebar-article" data-bs-parent="#sidebar">
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('service_types.index'))}}" href="{{route('service_types.index')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <i class="sidenav-mini-icon"> U </i>
                    <span class="item-name">Jenis Layanan</span>
                </a>
            </li>
        </ul>
    </li>
