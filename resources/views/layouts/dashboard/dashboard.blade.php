@props(['dir'])
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{ $dir ? 'rtl' : 'ltr' }}" data-bs-theme="light"
...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/tmy6n7njgm3jv6287bzh2536b6xx15am7i26wu2xfc5rno0h/tinymce/6/tinymce.min.js">
    </script>
    <script>
        tinymce.init({
            selector: '#mytextarea'
    ...
    <style>
        ...
        #menu .form-check-input:checked+.form-check-label {
            color: #ff0000;
            font-weight: bold;
        }
    </style>
...
<body class="">
    ...
    <div class="btn-download">
        <a class="btn btn-success px-3 py-2 mb-4"
    ...
    <a class="btn btn-fixed-end btn-secondary btn-icon btn-dashboard z-3"
